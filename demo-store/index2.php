...
<body>
<div class="container"><h1>La boutique de Sandra</h1>
...
<label for="account_alias">Identifiant du client(Email ou numéro de téléphone)</label>
<input type="text" name="account_alias" value="" placeholder="Email ou numéro de téléphone du client">
<input type="submit" value="Valider" class="checkout"> ou <a href="index2.php" title="Paiement PSR">Paiement avec PAYDUNYA</a>
</form>
<?php } ?>
</div>
</body>
